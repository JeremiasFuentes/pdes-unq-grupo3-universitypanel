...
public class CourseControllerTest {
	...
	public void testGetCourseById() throws Exception {
		...
		mockMvc.perform(get("/courses/1")).andExpect(status().isOk())
				...
				.andExpect(jsonPath("$.name", is(course.getName()))).andExpect(jsonPath("$.year", is(course.getYear())))
	...
	public void testCreateCourse() throws Exception {
		...
		mockMvc.perform(
				MockMvcRequestBuilders.post("/courses/").contentType(MediaType.APPLICATION_JSON).content(courseJson))
